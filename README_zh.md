...
- **代码规范**
  ...
  1. 所有的函数、类、类成员函数等都需要拥有`reStructuredText` 格式注释
  ...
  6. 不要嵌套定义函数，除了类成员函数外的所有函数都需要定义在所在文件的全局环境中
  
  7. 类外部可以访问类成员变量，但不要在类外部修改类成员变量，如果需要修改，请增加类成员函数。
...
该库还有很多的方法供您使用，更多内容可参阅[帮助文档](./docs/README.md)
